"""examples/example.ipynb 생성 스크립트.

실행:
    python examples/_build_example_notebook.py

노트북은 Colab / Jupyter 에서 곧바로 열어 실행 가능.
"""
...
def main() -> Path:
    ...
    out = Path(__file__).parent / "example.ipynb"
